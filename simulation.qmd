...
[documentation](https://asreview.readthedocs.io/en/latest/simulation_overview.html){target="_blank"}
...
exercise](https://github.com/asreview/asreview-academy/tree/main/introducing-ASReview-LAB){target="_blank"}.
...
exercise](ASReviewLAB.qmd){target="_blank"}.
...
[the instructions on installation](https://asreview.ai/download){target="_blank"}.
...
1.  Open ASReview LAB via the CLI (Command Line Interface) and start a
    ...
    [documentation](https://asreview.readthedocs.io/en/latest/simulation_webapp.html){target="_blank"}
...
(2022)](https://psyarxiv.com/t7bpd){target="_blank"}. Training the feature matrix for a
...
[documentation](https://asreview.readthedocs.io/en/latest/progress.html#summary-statistics){target="_blank"}.
...
review](https://asreview.nl/blog/project/evaluating-the-performance-of-active-learning-within-systematic-reviews/){target="_blank"}
on this topic.
...
line
interface](https://asreview.readthedocs.io/en/latest/simulation_cli.html#simulation-options){target="_blank"}.
...
[performance
metrics](https://github.com/asreview/asreview-insights#performance-metrics){target="_blank"}
...
![](images/Simulation/Folderstructure.png){width=95%}
...
simulation](https://asreview.readthedocs.io/en/latest/data_labeled.html#fully-labeled-data){target="_blank"}.
...
``` bash
asreview simulate data/[name_of_your_data.csv] --state_file output/[results_name].asreview --seed [your favorite number] --init_seed [your second favorite number]
```
...
arguments](https://asreview.readthedocs.io/en/latest/simulation_cli.html#simulation-via-command-line){target="_blank"},
...
active learning
model](https://asreview.readthedocs.io/en/latest/simulation_cli.html#active-learning){target="_blank"}
is used.
...
![](images/Simulation/Example_recall_curve.png){width=95%}
...
packages](https://github.com/asreview/asreview-insights#performance-metrics){target="_blank"}.
...
`Makita`: ASReview’s
[`Make It Automatic`](https://github.com/asreview/asreview-makita){target="_blank"}.
...
1.  Follow the first three steps under the [`Getting started`](https://github.com/asreview/asreview-makita#getting-started){target="_blank"} section. The result should be a new project folder including a subfolder titled 'data'. Put at least two [benchmark datasets](https://github.com/asreview/systematic-review-datasets#datasets){target="_blank"} in the 'data' folder. Make sure to save them as `.csv`
    ...
    *Note: if multiple datasets are available in this folder, Makita
    ...
    the [`Windows support`
    section](https://github.com/asreview/asreview-makita#windows-support){target="_blank"}.
...
arguments](https://github.com/asreview/asreview-makita#templates){target="_blank"}.
...
datasets](https://github.com/asreview/systematic-review-datasets#datasets){target="_blank"}
...
template](https://github.com/asreview/asreview-makita#arfi-template){target="_blank"}.
...
[template](https://github.com/asreview/asreview-makita#multiple-models-template){target="_blank"}
...
templates](https://github.com/asreview/asreview-makita#advanced-usage){target="_blank"},
or adding [new
models](https://github.com/asreview/template-extension-new-model){target="_blank"}.
